...
type LayoutRouteId = RouteId | "/(public)" | "/(public)/about" | "/(public)/contact" | "/(public)/login" | "/(public)/register"
...
export type LayoutServerData = Expand<OptionalUnion<EnsureDefined<Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../src/routes/(public)/+layout.server.js').load>>>>>>;
